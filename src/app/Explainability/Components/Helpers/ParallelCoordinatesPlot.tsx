...
const ParallelCoordinatesPlot = ({ data }) => {
  const spec = {
      ...
      "description": "Parallel coordinates plot for your data",
      "data": {
        "values": data
      },
      "width": 600,
      ...
      "transform": [
        ...
        {"fold": ["Model__batch_size", "Model__lr" , "BinaryLabel", "Cost"]},
        {
          "joinaggregate": [
      ...
      "layer": [{
        ...
        "encoding": {
          ...
          "tooltip": [
            {"type": "quantitative", "field": "Model__batch_size"},
            {"type": "quantitative", "field": "Model__lr"},
            {"type": "quantitative", "field": "Model__optimizer"},
            {"type": "quantitative", "field": "preprocessor__num__scaler"},
            {"type": "quantitative", "field": "BinaryLabel"},
            {"type": "quantitative", "field": "Cost"}
          ]
        }
      }, {
        "encoding": {
